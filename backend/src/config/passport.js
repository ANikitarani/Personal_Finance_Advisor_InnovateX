...
// Google OAuth is optional for local runs.
// If env vars are missing, skip registering the strategy so the server can start.
if (process.env.GOOGLE_CLIENT_ID && process.env.GOOGLE_CLIENT_SECRET) {
  ...
  console.warn(
    "[passport] GOOGLE_CLIENT_ID/GOOGLE_CLIENT_SECRET not set. Skipping Google OAuth strategy."
  );
}
